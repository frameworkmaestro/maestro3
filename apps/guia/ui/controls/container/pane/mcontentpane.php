 ...
 * 02110-1301, USA.
 */
class MContentPane extends MContainerControl {
    ...
    public function setDoLayout($value){
        $this->property->doLayout = $value;
    }
    
    public function getDoLayout(){
        return $this->property->doLayout;
    }
}
?>
