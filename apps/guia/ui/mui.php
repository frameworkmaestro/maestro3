...
class MUI {
    ...
    public function openWindow($id) {
        return "manager.getWindow(\"{$id}\").open();";
    }

    public function closeWindow($id = '') {
        return "manager.getWindow(\"{$id}\").close();";
    }
    ...
    public static function toggle($id) {
        return "manager.toggle(\"{$id}\");";
    }

    public static function highlight($id) {
        return "dojo.toggleClass(\"{$id}\",\"highlight\",true);";
    }

    public static function replace($id, $html) {
        return "dojo.byId(\"{$id}\").innerHTML = \"{$html}\";";
    }

    public static function copyValue($idFrom, $idTo) {
        return "dojo.byId(\"{$idTo}\").value = dojo.byId(\"{$idFrom}\").value;";
    }
